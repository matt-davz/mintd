...
The frontend styles are generated by Stitch. The design direction is:
- Dark luxury aesthetic — deep blacks, single electric blue or cold platinum accent
- Futuristic, minimal, premium — think Porsche configurator or Linear.app
- No gradients on backgrounds, no bright colors, no sports clichés
- Typography: condensed headline font + clean body font + monospace for cert IDs and grades
- Cards: dark surface, large image, grade badge in muted gold, cert ID in monospace

Do not override or fight the Stitch-generated styles. Work within them.
