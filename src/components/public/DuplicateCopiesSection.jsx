...
export function DuplicateCopiesSection({ itemId, onItemClick }) {
  ...
  function renderCard(link) {
    const image = link.otherImageUrl ? (
    ...
    if (onItemClick) {
      return <CardBtn key={link.otherItemId} onClick={() => onItemClick(link.otherItemId)}>{inner}</CardBtn>
    }
    return <CardLink key={link.otherItemId} to={`/item/${link.otherItemId}`}>{inner}</CardLink>
  }
  ...
  return (
    <Wrap>
      <Header onClick={() => setOpen(o => !o)}>
        ...
        <HeaderLabel>Duplicate copies in collection</HeaderLabel>
        {!open && <HeaderMeta>View copies</HeaderMeta>}
      </Header>
