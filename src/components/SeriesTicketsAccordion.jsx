...
import { useSeriesTickets } from '../hooks/useSeriesTickets'
...
export function SeriesTicketsAccordion({ seasonYear, currentItemId, onItemClick }) {
  ...
  function renderCard(t) {
    const image = t.primary_image_url ? (
      <img src={t.primary_image_url} alt={t.title} loading="lazy" />
    ) : (
  ...
  return (
    <Wrap>
      <Header onClick={() => setOpen(o => !o)}>
        ...
        <HeaderLabel>{seasonYear} World Series Tickets</HeaderLabel>
        {!open && <HeaderMeta>View series</HeaderMeta>}
      </Header>
        ...
        <Body>
          ...
          <Track ref={trackRef}>
            {loading
              ...
              : tickets.length === 0
                ? <HeaderMeta style={{ padding: 'var(--space-4) 0' }}>No other tickets from this series</HeaderMeta>
