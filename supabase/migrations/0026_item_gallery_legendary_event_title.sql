-- ============================================================
-- 0026_item_gallery_legendary_event_title.sql
-- Expose legendary_context.event_title in item_gallery so the
-- Timeline can render it above the card image without a
-- separate fetch.  NULL for all non-legendary items.
-- ============================================================
...
comment on view public.item_gallery is 'Denormalised view for the public gallery — one row per item with tag_slugs, team_slugs, season_year, primary cert, is_legendary, game_date, series_game_number, and legendary_event_title aggregated.';
