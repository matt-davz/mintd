-- ============================================================
-- 0025_item_gallery_game_date.sql
-- Expose game_date and series_game_number from game_context in
-- item_gallery so the Timeline can sort by exact game date rather
-- than season_year alone.  Items without game context (cards, etc.)
-- get NULL for both columns and fall back to season_year on the
-- client side.
-- ============================================================
...
comment on view public.item_gallery is 'Denormalised view for the public gallery — one row per item with tag_slugs, team_slugs, season_year, primary cert, is_legendary, game_date, and series_game_number aggregated.';
