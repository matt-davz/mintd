-- ============================================================
-- 0027_fix_gallery_duplicate_signers.sql
-- Migrations 0025 and 0026 recreated item_gallery but reverted
-- the LATERAL signatories fix from 0021, reintroducing duplicates
-- for items with multiple is_featured signatories.
-- Restore LATERAL + LIMIT 1 for signatories and add back
-- signatory_count (also lost). Preserves game_date,
-- series_game_number, is_legendary, and legendary_event_title.
-- ============================================================
